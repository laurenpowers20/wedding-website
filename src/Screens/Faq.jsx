  ...
  return (
    <>
      ...
      <div className="faq-questions">
        ...
        <p>
          We had a small ceremony last year at City Hall. We're just having the
          party in July!{" "}
        </p>
      </div>
      <div className="faq-questions">
        ...
        <p>
          {" "}
          We ask that you only bring those listed on your invitation. We'd love
          to accomodate others, but there are space limitations.{" "}
        </p>
      </div>
      <div className="faq-questions">
        ...
        <p>
          ...
          station. See Travel & Stay for more info.{" "}
        </p>
      </div>
      <div className="faq-questions">
        <p>What is the dress code?</p>
        <p>Cocktail attire or semi-formal is good!</p>
      </div>
      <div className="faq-questions">
        <p>Will there be an after party?</p>
        <p>Maybe we'll all go out in Bay Shore if we are feeling up to it?!</p>
      </div>
    </>
  );
}
